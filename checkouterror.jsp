...
<body>
    ...
    <p>Incorrect room id or customer's email or invalid input pattern, please double-check everything you enter before submitting and try again</p>
    <form action="RoomCheckOut" method="POST">
        <label for="ma">Enter room's id you want to check out</label><br><br>
        <input type="text" id="ma" name="id" placeholder="You can enter more than one room's id, each one is separated by a comma." size="70"/><br><br>

...
<body>
    ...
    <p>The old password is not correct or the two other passwords are not the same, please double-check everything you enter before submitting and try again</p>
    <form action="PasswordChanging" method="POST">
        ...
        <label for="repeat">Enter the new password again</label><br><br>

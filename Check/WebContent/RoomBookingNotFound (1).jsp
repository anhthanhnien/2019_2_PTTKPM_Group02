...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="RoomBookingNotFound.css">
</head>
<body>
    <ol> 
    ...
    <h1>BOOKING ERROR</h1>
    <p>That type of room was run out on that day or not in our room category, please choose another type or modify your arrival date if you can :)</p>
